...
import static week12d02.Fence.PERFECT;
...
public class Street {
    ...
    public static void main(String[] args) {
       ...
       /* 0 10 PERFECT
        ...
        0 11 NO_FENCE
        1 13 PERFECT*/
        Site s1 = new Site(Side.values()[0], 10, Fence.PERFECT);
        Site s2 = new Site(Side.values()[0], 7, Fence.NEED_UPGRADE);
        Site s3 = new Site(Side.values()[1], 12, Fence.PERFECT);
        Site s4 = new Site(Side.values()[0], 9, Fence.PERFECT);
        Site s5 = new Site(Side.values()[0], 11, Fence.NO_FENCE);
        Site s6 = new Site(Side.values()[1], 13, Fence.PERFECT);
        street.sellSite(s1);
        street.sellSite(s2);
        street.sellSite(s3);
        street.sellSite(s4);
